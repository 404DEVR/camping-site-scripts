...
def train_model(X_train, y_train):
    """Train K-Nearest Neighbors classifier with feature scaling."""
...
def evaluate_model(model, scaler, X_train, X_test, y_train, y_test):
    ...
    print(f"Distance parameter (p): {model.p}")
...
def main():
    ...
    print("CUSTOM TRAIN/TEST KNN PIPELINE")
    print("=" * 40)
    ...
    try:
        ...
        # Evaluate model
        accuracy, predictions = evaluate_model(model, scaler, X_train, X_test, y_train, y_test)
